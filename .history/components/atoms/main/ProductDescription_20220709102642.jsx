...
export const ProductDescription = () => {
    ...
    const mainItem = externalApiShoes[1];
  ...
  <h1 className="main-title">{mainItem?.title} <span>Most Popular</span></h1>
  ...
  <div className="main-product-picture">
    <img src={mainItem?.image} className="main-picture" alt={mainItem?.title} />
  </div>
</section>
    </React.Fragment>    
  )
