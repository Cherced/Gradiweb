...
export const NavBar = () => {
  return (
    <div className="navBar__container" aria-label="header navegation container">
    <img className="navBar__container--image" src="/images/logo-white.png" alt="Logo Converse" />
